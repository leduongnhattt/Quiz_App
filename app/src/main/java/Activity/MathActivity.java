...
public class MathActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Thiết lập lại màu của StatusBar
        ...
        LinearLayout mainLayout = findViewById(R.id.mathPage);
    ...
    private void getDataFromFirebase() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                quizModelList.clear(); // Xóa trùng lặp dữ liệu
                ...
                for (DataSnapshot quizSnapshot : dataSnapshot.getChildren()) {
                    ...
                    // Kiểm tra xem category có phải là "Math" không
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("FirebaseData", "Lỗi truy xuất dữ liệu: " + databaseError.getMessage());
            }
        });
    }
}
